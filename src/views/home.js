...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Shallow Darling Termite</title>
        <meta property="og:title" content="Shallow Darling Termite" />
      </Helmet>
      <div className="home-header">
        ...
        >
          <span className="logo">JIA XU</span>
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              ...
              <span className="home-nav4 bodySmall">Portfolio</span>
      ...
      <div className="home-hero">
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">Jia Xu</h1>
        ...
        <div className="featuresContainer">
          <div className="home-features1">
            <div className="home-container02">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Unlock the full potential of your website with these
                      amazing features
                    </span>
                    <span>
                      <span
            ...
            <div className="home-container03">
              <FeatureCard
                heading="Feature 1"
                subHeading="Output JSON for easy integration"
              ></FeatureCard>
              <FeatureCard
                heading="Feature 2"
                subHeading="Secure and reliable data transfer"
              ></FeatureCard>
              <FeatureCard
                heading="Feature 3"
                subHeading="Efficient and scalable performance"
              ></FeatureCard>
              <FeatureCard
                heading="Feature 4"
                subHeading="Flexible customization options"
              ></FeatureCard>
            </div>
          </div>
        </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">
            Welcome to Jia Xu&apos;s Professional Website
          </h1>
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Jia Xu is a highly skilled professional with expertise in
                  various fields. This website showcases Jia Xu&apos;s work,
                  skills, and achievements. Explore the website to learn more
                  about Jia Xu and their professional journey.
                </span>
                <span>
                  <span
                    dangerouslySetInnerHTML={{
          ...
          <button className="buttonFilled">Explore</button>
        </div>
      </div>
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="We offer a wide range of services including web design, web development, graphic design, and digital marketing."
                question="What services do you offer?"
              ></Question1>
              <Question1
                answer="The cost of our services varies depending on the specific project requirements. Please contact us for a personalized quote."
                question="How much do your services cost?"
              ></Question1>
              <Question1
                answer="Yes, we provide ongoing support and maintenance services to ensure your website runs smoothly and stays up-to-date."
                question="Do you provide ongoing support after the website is launched?"
              ></Question1>
              <Question1
                answer="Yes, we can assist with website content creation, including copywriting and content strategy, to ensure your website effectively communicates your message."
                question="Can you help with website content creation?"
              ></Question1>
              <Question1
                answer="The turnaround time for website development depends on the complexity of the project. We will provide you with an estimated timeline during the initial consultation."
                question="What is your turnaround time for website development?"
              ></Question1>
            </div>
          </div>
        </div>
